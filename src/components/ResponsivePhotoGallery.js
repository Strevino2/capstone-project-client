...
export default function ResponsivePhotoGallery() {
  return (
    <div className="responsive-gallery">
      <h3>React-Responsive-Gallery Playground</h3>
      <h5>
        Start editing code and change screen width to see some magic happen!
      </h5>
      <ResponsiveGallery
        useLightBox
        images={[
